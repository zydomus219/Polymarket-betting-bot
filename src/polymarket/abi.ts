export const abi = [
    {
        inputs: [
            { internalType: 'address', name: '_negRiskCtfExchange', type: 'address' },
            { internalType: 'address', name: '_negRiskAdapter', type: 'address' },
    ...
    },
    {
        inputs: [],
        name: 'exchange',
        outputs: [{ internalType: 'contract IExchange', name: '', type: 'address' }],
        stateMutability: 'view',
        type: 'function',
    },
    {
    ...
    },
    {
        inputs: [
            ...
            { internalType: 'uint256[]', name: 'makerFillAmounts', type: 'uint256[]' },
            { internalType: 'uint256', name: 'makerFeeRate', type: 'uint256' },
        ],
        name: 'matchOrders',
        outputs: [],
        stateMutability: 'nonpayable',
